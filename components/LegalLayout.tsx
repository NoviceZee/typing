...
export function LegalSection({ title, children }: React.PropsWithChildren<{ title: string }>) { return <section><h2 className="font-mono text-section uppercase tracking-wide text-brass">{title}</h2><div className="mt-3 space-y-3 text-body leading-7 text-paper/58">{children}</div></section>; }
