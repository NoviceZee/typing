  ...
  return <>
    ...
    <main className="min-h-screen bg-ink-950 px-5 py-6 text-paper md:px-8">
      <div className="mx-auto max-w-4xl">
        <header className="flex items-center justify-between border-b border-paper/10 pb-5"><Link href="/" className="font-mono text-lg font-semibold tracking-[0.18em]">Typing Station</Link><Link href="/practice" className="font-mono text-xs text-paper/45 transition hover:text-brass">Return to practice</Link></header>
