Create one horizontal animation strip for Codex pet `tippy`, state `running-right`.
...
Identity: same pet in every frame: Compact orange tabby cat desk companion with a warm coral scarf, expressive amber eyes, a small silver paperclip tail charm, rounded paws, clever and kind personality, inspired by typing, editing, making, and thoughtful iteration; readable at pet size.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
Style: Pet-safe sprite: compact full-body mascot, readable in a 192x208 cell, clear silhouette, simple face, stable palette/materials, and crisp edges for chroma-key extraction. Style `3d-toy`: Stylized 3D toy mascot with smooth rounded forms, simple materials, clear silhouette, and no photoreal complexity. User style notes: Polished toy-like mascot illustration, soft matte materials, crisp silhouette, expressive face, minimal accessories, no text..
