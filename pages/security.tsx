...
export default function SecurityPage() { return <LegalLayout title="Security" summary="How Typing Station protects accounts and data, and how to report a potential vulnerability.">
  <LegalSection title="Current safeguards"><p>Typing Station uses Supabase authentication, row-level database policies, user-scoped reads and writes, private attempt details, restricted admin roles and HTTPS hosting. Passwords are handled by the authentication provider and are not stored in the Typing Station application database.</p></LegalSection>
