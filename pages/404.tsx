  ...
  return (
    <AppShell sideAd={false} topAd={false}>
      <section className="mx-auto max-w-xl py-12 text-center md:py-20">
        ...
        <Link href="/practice" className="mt-7 inline-flex rounded-md border border-brass/35 bg-brass/10 px-4 py-2.5 font-mono text-sm text-brass transition hover:bg-brass/15 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brass/70">
          Return to practice
        </Link>
      </section>
    </AppShell>
